...
bool CYsfProtocol::Init(void)
{
    ...
    m_ReflectorCallsign.PatchCallsign(0, (const uint8_t *)"YSF", 3);
    ...
    *header = NULL;
    ...
    if ( Fich.getFI() == YSF_FI_HEADER )
    {
        ...
        // and 2 DV Frames
        {
            ...
            frames[0] = new CDvFramePacket(uiAmbe, uiStreamId, Fich.getFN(), 0, (uint8_t)0);
            frames[1] = new CDvFramePacket(uiAmbe, uiStreamId, Fich.getFN(), 1, (uint8_t)0);
        }
...
bool CYsfProtocol::IsValidDvLastFramePacket(const CIp &Ip, const CYSFFICH &Fich, const CBuffer &Buffer, CDvFramePacket **frames)
{
    ...
    if ( Fich.getFI() == YSF_FI_TERMINATOR )
    {
        ...
        // get DV frames
        {
            ...
            ::memset(uiAmbe, 0x00, sizeof(uiAmbe));
            frames[0] = new CDvFramePacket(uiAmbe, uiStreamId, Fich.getFN(), 0, (uint8_t)0);
            frames[1] = new CDvLastFramePacket(uiAmbe, uiStreamId, Fich.getFN(), 1, (uint8_t)0);
        }
